...
n = sys.argv[1]
input_file = n+"-grams.txt"
index_file = n+"-gram-index.txt"
...
first = True
with codecs.open(input_file,'rb',encoding='utf8') as file_read:
    line = file_read.readline()
    with codecs.open(index_file,'w',encoding='utf8') as file_write:
